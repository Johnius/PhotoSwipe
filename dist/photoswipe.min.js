...
0===j&&(U=!1,e.unbind(window,p,f),yb(),_?k=0:-1!==rb&&(k=Da()-rb)),rb=1===j?Da():-1,g=-1!==k&&150>k?"zoom":"swipe",_&&2>j&&(_=!1,1===j&&(g="zoomPointerUp"),Ca("zoomGestureEnded")),$=null,X||W||ea||S)if(bb(),Q||(Q=Rb()),Q.calculateSwipeSpeed("x"),Q.calculateSwipeSpeed("y"),S){var l=Hb(),m=oa.y,n=ia;if(l<i.verticalDragRange){var o=pa.y,q=f.currItem.h*f.currItem.fitRatio,r=m,t=o/2>r+q/2,u=Math.abs(Q.lastFlickSpeed.y),v=(t?q+r:o-r)/u;v=v>300?300:v,cb("verticalDragOut",0,1,v,e.easing.cubic.out,function(a){var b=pa.y,c=f.currItem.h*f.currItem.fitRatio,d=m,e=b/2>d+c/2,g=(c+d)*-a+d,h=(b-d)*a+d;oa.y=e?g:h,Ea(-n*a+n),Ga()},f.close)}else cb("verticalDrag",0,1,300,e.easing.cubic.out,function(a){oa.y=(f.currItem.initialPosition.y-m)*a+m,Ea((1-n)*a+n),Ga()}),Ca("onVerticalDrag",1)}else{
// main scroll 
if((Z||ea)&&0===j){var w=Tb(g,Q);if(w)return;g="zoomPointerUp"}
...
Rb=function(){
// temp local vars
var a,b={lastFlickOffset:{},lastFlickDist:{},lastFlickSpeed:{},lastFlickDuration:0,slowDownRatio:{},slowDownRatioReverse:{},speedDecelerationRatio:{},speedDecelerationRatioAbs:{},distanceOffset:{},backAnimDestination:{},backAnimStarted:{},calculateSwipeSpeed:function(c){nb.length>1?(b.lastFlickDuration=Da()-P+50,a=nb[nb.length-2][c]):(b.lastFlickDuration=Da()-O,// total gesture duration
a=kb[c]),b.lastFlickOffset[c]=jb[c]-a,b.lastFlickDist[c]=Math.abs(b.lastFlickOffset[c]),b.lastFlickDist[c]>20?b.lastFlickSpeed[c]=b.lastFlickOffset[c]/b.lastFlickDuration:b.lastFlickSpeed[c]=0,Math.abs(b.lastFlickSpeed[c])<.1&&(b.lastFlickSpeed[c]=0),b.slowDownRatio[c]=.95,b.slowDownRatioReverse[c]=1-b.slowDownRatio[c],b.speedDecelerationRatio[c]=1},calculateOverBoundsAnimOffset:function(a,c){b.backAnimStarted[a]||(oa[a]>ca.min[a]?b.backAnimDestination[a]=ca.min[a]:oa[a]<ca.max[a]&&(b.backAnimDestination[a]=ca.max[a]),void 0!==b.backAnimDestination[a]&&(b.slowDownRatio[a]=.7,b.slowDownRatioReverse[a]=1-b.slowDownRatio[a],b.speedDecelerationRatioAbs[a]<.05&&(b.lastFlickSpeed[a]=0,b.backAnimStarted[a]=!0,cb("bounceZoomPan"+a,oa[a],b.backAnimDestination[a],c||300,e.easing.sine.out,function(b){oa[a]=b,Ga()}))))},
// Reduces the speed by slowDownRatio (per 10ms)
calculateAnimOffset:function(a){b.backAnimStarted[a]||(b.speedDecelerationRatio[a]=b.speedDecelerationRatio[a]*(b.slowDownRatio[a]+b.slowDownRatioReverse[a]-b.slowDownRatioReverse[a]*b.timeDiff/10),b.speedDecelerationRatioAbs[a]=Math.abs(b.lastFlickSpeed[a]*b.speedDecelerationRatio[a]),b.distanceOffset[a]=b.lastFlickSpeed[a]*b.speedDecelerationRatio[a]*b.timeDiff,oa[a]+=b.distanceOffset[a])},panAnimLoop:function(){
// round pan position
return Za.zoomPan&&(Za.zoomPan.raf=H(b.panAnimLoop),b.now=Da(),b.timeDiff=b.now-b.lastNow,b.lastNow=b.now,b.calculateAnimOffset("x"),b.calculateAnimOffset("y"),Ga(),b.calculateOverBoundsAnimOffset("x"),b.calculateOverBoundsAnimOffset("y"),b.speedDecelerationRatioAbs.x<.05&&b.speedDecelerationRatioAbs.y<.05)?(oa.x=Math.round(oa.x),oa.y=Math.round(oa.y),Ga(),void _a("zoomPan")):void 0}};return b},Sb=function(a){
...
if(!j||!h||void 0===h.x)return Ca("initialZoom"+(d?"Out":"In")),s=b.initialZoomLevel,La(oa,b.initialPosition),Ga(),a.style.opacity=d?0:1,Ea(1),void(j&&!d?setTimeout(function(){k()},j):k());var n=function(){var c=l,g=!f.currItem.src||f.currItem.loadError||i.showHideOpacity;
